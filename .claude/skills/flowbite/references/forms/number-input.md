...
If you're using the <a href="/docs/getting-started/typescript">TypeScript configuration</a> from Flowbite then you can import the types for the InputCounter object, parameters and its options.
